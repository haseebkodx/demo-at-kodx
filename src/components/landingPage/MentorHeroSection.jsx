...
import sideBg from "../../assets/images/mentorBg.png";
        ...
        <div className="sm:static absolute z-50 top-60 left-0 sm:w-full flex items-center justify-center pt-10">
          <div className="sm:px-8 px-[120px] mt-0 sm:mt-4">
            <div className="flex flex-col sm:justify-center sm:items-center">
              <p className="font-lato font-bold text-[24px] text-[#C9E1FF] tracking-[6px] sm:text-[20px]">
                MPP MENTORS
              </p>
              <h1 className="font-lato font-bold text-white text-[52px] leading-none sm:text-center sm:text-[30px]">
                Give. Guide. Grow.
              </h1>
              <p className="font-lato max-w-[600px] font-normal leading-[1.3] text-[25px] text-white sm:text-base pb-2 sm:text-center">
                <span className="text-[28px] sm:text-[22px] font-semibold text-[#FFE45F]">
                  MPP Mentors
                </span>{" "}
                develop long-term relationships with small businesses, curate a
                high-quality subcontracting pool, pursue new market
                opportunities as part of a team, receive cost reimbursement, and
                earn a credit towards small business contracting goals.
              </p>
